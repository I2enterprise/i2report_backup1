report 57110 "I2_Accrued Cost2"
{
    ApplicationArea = All;
    Caption = '.I2_Accrued Cost';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    PreviewMode = PrintLayout;

    RDLCLayout = './src/ReportRDL/I2_Accrued Cost2.rdl';
    dataset
    {
        dataitem(DimensionValue; "Dimension Value")
        {
            ...
            begin
                ...
                if "Dimension Code" = 'PROJECT NO' then begin
                    ...
                    // GetGLAmt('219210', Code, '', IncomeAmt[1]);
                    // GetGLAmt('219220', Code, '', IncomeAmt[2]);
                    // GetGLAmt('219420', Code, '', IncomeAmt[3]);
                ...
                // flash ไม่แสดงบน report 
                if (OtherAmt[1] + otherAmt[6] + otherAmt[2] + otherAmt[7]) = 0 then begin
                    hidereport := true
